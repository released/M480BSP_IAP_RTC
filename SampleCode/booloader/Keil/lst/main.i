...
void compare_buffer(uint8_t *src, uint8_t *des, int nBytes)
{
    ...
    for (i = 0; i < nBytes; i++)
    {
        if (src[i] != des[i])
        {
			...
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_error))) : ((BitFlag&=~(uint32_t)(1<<flag_error))));
        }
    }
	...
	{
    	printf("%s finish \r\n" , __FUNCTION__);	
		( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_error))) : ((BitFlag&=~(uint32_t)(1<<flag_error))));
	}
...
{
	TIMER_Delay(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL)), 1000*ms);
}
...
int  load_image_to_flash(uint32_t image_base, uint32_t image_limit, uint32_t flash_addr, uint32_t max_size)
{
    ...
    for (i = 0; i < u32ImageSize; i += 0x1000UL)
    {

        FMC_Erase(flash_addr + i);
        for (j = 0; j < 0x1000UL; j += 4)
        {
...
void Jump_To_Application(void)
{
	...
	FMC_Enable();
    FMC_SetVectorPageAddr((0x00008000UL));
    ...
    while (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->PDID) __wfi();
...
void GPIO_Init (void)
{
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00004000UL), 0x1UL);

    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00008000UL), 0x1UL);	
}
...
{	
	...
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)),(0x00000040UL),0x1UL);	
}
...
void SYS_Init(void)
{
    ...
    CLK_EnableXtalRC((0x1ul << (0))|(0x1ul << (2)));

     
    CLK_WaitClockReady((0x1ul << (0))|(0x1ul << (4)));

    CLK_EnableXtalRC((0x1ul << (1))|(0x1ul << (3)));

     
    CLK_WaitClockReady((0x1ul << (1))|(0x1ul << (3)));
    ...
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x1UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(1UL<<0)), (0x0UL << (8)),  0);
...
int main()
{
    ...
    while(1)
    {
		...
		if ((((BitFlag&(uint32_t)(1<<flag_update_fw))?1:0)))
		{
